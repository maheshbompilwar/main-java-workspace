...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        try{
            StudentEntity userLoginRequestModel = new ObjectMapper()
                    .readValue(request.getInputStream(), StudentEntity.class);
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) throws IOException, ServletException {
        ...
        StudentService userService = (StudentService) SpringApplicationContext.getBean("studentService");
        StudentEntity userDto = userService.getStudentByUsername(username);
